...
--From WEEK 5: Getting table and column details - LOADING DATA, SQL chicago crime data assignment (future project idea)
--From WEEK 6: VIEWS, STORED PROCEDURES, INNER JOINS, OUTER JOINS (Chicago crime data assignment with joins-views-stored procedures
-- From Alex Analyst YT Series, CTE's and other queries he conducts...only do this after done all of IBM content on this Query Set
